...
CREATE TABLE IF NOT EXISTS source_inventory (
  ...
  mail_import_session_id text NOT NULL,
...
CREATE TABLE IF NOT EXISTS claim_requirement (
  ...
  payload_hash text NOT NULL,
  updated_at timestamptz NOT NULL DEFAULT now(),
  UNIQUE (claim_requirement_id, mail_import_session_id, workspace_id, owner_user_id),
  FOREIGN KEY (
    mail_import_session_id,
    workspace_id,
    owner_user_id
