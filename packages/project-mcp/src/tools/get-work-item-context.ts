...
import type { GetWorkItemContextEnvelope, GetWorkItemContextInput } from "./project-tools";
...
export abstract class GetWorkItemContextHandler {
  abstract get_work_item_context(input: GetWorkItemContextInput): Promise<GetWorkItemContextEnvelope>;
}
