...
Abstract Project MCP server package.

This package owns project execution context, project-system adapter boundaries, evidence snapshots, and project write proposals.
