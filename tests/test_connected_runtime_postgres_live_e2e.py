            ...
            def revoke_token_session(
                ...
                *,
                ...
                if self.name != "retired":
                    raise AssertionError("unexpected revocation runtime")
                if token_session_id != "session_revoked":
                    raise AssertionError("unexpected token session")
                if reason_code != "live_e2e_revoked":
                    raise AssertionError("unexpected revocation reason")
                if operator_service_id != "operator_live_e2e":
                    raise AssertionError("unexpected operator service")
